...
class tDAL
{
	var $tblpqrsf_at_localhost__Administrator;
	var $tblpqrsf_at_localhost__BaseProcedure;
	var $tblpqrsf_at_localhost__Document;
	var $tblpqrsf_at_localhost__report;
	var $tblpqrsf_at_localhost__Requestor;
	var $tblpqrsf_at_localhost__Response;
	var $tblpqrsf_at_localhost__Tracking;
	var $lstTables;
	var $Table = array();
	...
	function FillTablesList()
	{
		if($this->lstTables)
			return;
		$this->lstTables[] = array("name" => "Administrator", "varname" => "pqrsf_at_localhost__Administrator", "altvarname" => "Administrator", "connId" => "pqrsf_at_localhost", "schema" => "", "connName" => "pqrsf at localhost");
		$this->lstTables[] = array("name" => "BaseProcedure", "varname" => "pqrsf_at_localhost__BaseProcedure", "altvarname" => "BaseProcedure", "connId" => "pqrsf_at_localhost", "schema" => "", "connName" => "pqrsf at localhost");
		$this->lstTables[] = array("name" => "Document", "varname" => "pqrsf_at_localhost__Document", "altvarname" => "Document", "connId" => "pqrsf_at_localhost", "schema" => "", "connName" => "pqrsf at localhost");
		$this->lstTables[] = array("name" => "report", "varname" => "pqrsf_at_localhost__report", "altvarname" => "report", "connId" => "pqrsf_at_localhost", "schema" => "", "connName" => "pqrsf at localhost");
		$this->lstTables[] = array("name" => "Requestor", "varname" => "pqrsf_at_localhost__Requestor", "altvarname" => "Requestor", "connId" => "pqrsf_at_localhost", "schema" => "", "connName" => "pqrsf at localhost");
		$this->lstTables[] = array("name" => "Response", "varname" => "pqrsf_at_localhost__Response", "altvarname" => "Response", "connId" => "pqrsf_at_localhost", "schema" => "", "connName" => "pqrsf at localhost");
		$this->lstTables[] = array("name" => "Tracking", "varname" => "pqrsf_at_localhost__Tracking", "altvarname" => "Tracking", "connId" => "pqrsf_at_localhost", "schema" => "", "connName" => "pqrsf at localhost");
	}
