...
class ConnectionManager_Base
{
	...
	{
		return $this->byId( "pqrsf_at_localhost" );
	}
	...
	{
		$connectionsIds = array();
		$connectionsIds["requestor"] = "pqrsf_at_localhost";
		$connectionsIds["baseprocedure"] = "pqrsf_at_localhost";
		$connectionsIds["report"] = "pqrsf_at_localhost";
		$connectionsIds["document"] = "pqrsf_at_localhost";
		$connectionsIds["response"] = "pqrsf_at_localhost";
		$connectionsIds["tracking"] = "pqrsf_at_localhost";
		$connectionsIds["Pchart"] = "pqrsf_at_localhost";
		$connectionsIds["Rchart"] = "pqrsf_at_localhost";
