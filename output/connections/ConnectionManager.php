...
class ConnectionManager extends ConnectionManager_Base
{
	...
	protected function _setConnectionsData()
	{
		...
		$data = array();
		$data["dbType"] = 0;
		$data["connId"] = "pqrsf_at_localhost";
		$data["connName"] = "pqrsf at localhost";
		$data["connStringType"] = "mysql";
		$data["connectionString"] = "mysql;localhost;root;;;pqrsf;;1"; //currently unused

		$this->_connectionsIdByName["pqrsf at localhost"] = "pqrsf_at_localhost";
		...
		$data["connInfo"][2] = "";
		$data["connInfo"][3] = "";
		$data["connInfo"][4] = "pqrsf";
		$data["connInfo"][5] = ""; //currently unused
		$data["connInfo"][6] = "1"; //currently unused
		$data["ODBCString"] = "DRIVER={MySQL ODBC 3.51 Driver};Server=localhost;Uid=root;Pwd=;Database=pqrsf;OPTION=3";
		// encription set
		...
		$connectionsData["pqrsf_at_localhost"] = $data;
