...
//				$this->strLabel = $params['name'];
	...
	protected function isProjectDB()
	{
		...
		if("requestor" == $this->chrt_array['tables'][0])
			return true;
		if("baseprocedure" == $this->chrt_array['tables'][0])
			return true;
		if("report" == $this->chrt_array['tables'][0])
			return true;
		if("document" == $this->chrt_array['tables'][0])
			return true;
		if("response" == $this->chrt_array['tables'][0])
			return true;
		if("tracking" == $this->chrt_array['tables'][0])
			return true;
