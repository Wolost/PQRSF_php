...
function fillProjectEntites()
{
	...
	if( count( $projectEntities ) )
		return;
	$projectEntities[ "requestor" ] = array( "url" => "requestor", "type" => 0 );
	$projectEntitiesReverse[ "requestor" ] = "requestor";
	$projectEntities[ "baseprocedure" ] = array( "url" => "baseprocedure", "type" => 0 );
	$projectEntitiesReverse[ "baseprocedure" ] = "baseprocedure";
	$projectEntities[ "report" ] = array( "url" => "report1", "type" => 0 );
	$projectEntitiesReverse[ "report1" ] = "report";
	$projectEntities[ "document" ] = array( "url" => "document", "type" => 0 );
	$projectEntitiesReverse[ "document" ] = "document";
	$projectEntities[ "response" ] = array( "url" => "response", "type" => 0 );
	$projectEntitiesReverse[ "response" ] = "response";
	$projectEntities[ "tracking" ] = array( "url" => "tracking", "type" => 0 );
	$projectEntitiesReverse[ "tracking" ] = "tracking";
	$projectEntities[ "Dashboard" ] = array( "url" => "dashboard", "type" => 4 );
	$projectEntitiesReverse[ "dashboard" ] = "Dashboard";
	$projectEntities[ "Pchart" ] = array( "url" => "pchart", "type" => 3 );
	$projectEntitiesReverse[ "pchart" ] = "Pchart";
	$projectEntities[ "Rchart" ] = array( "url" => "rchart", "type" => 3 );
	$projectEntitiesReverse[ "rchart" ] = "Rchart";
}
