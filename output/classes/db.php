...
class DB
{
	...
	*/
	...
	protected static function _fillTablesList( $conn )
	{
		...
		if( "pqrsf_at_localhost" == $conn->connId )
		{
			$dalTables[$conn->connId][] = array("name" => "Administrator", "varname" => "pqrsf_at_localhost__Administrator", "altvarname" => "Administrator", "connId" => "pqrsf_at_localhost", "schema" => "", "connName" => "pqrsf at localhost");
			$dalTables[$conn->connId][] = array("name" => "BaseProcedure", "varname" => "pqrsf_at_localhost__BaseProcedure", "altvarname" => "BaseProcedure", "connId" => "pqrsf_at_localhost", "schema" => "", "connName" => "pqrsf at localhost");
			$dalTables[$conn->connId][] = array("name" => "Document", "varname" => "pqrsf_at_localhost__Document", "altvarname" => "Document", "connId" => "pqrsf_at_localhost", "schema" => "", "connName" => "pqrsf at localhost");
			$dalTables[$conn->connId][] = array("name" => "report", "varname" => "pqrsf_at_localhost__report", "altvarname" => "report", "connId" => "pqrsf_at_localhost", "schema" => "", "connName" => "pqrsf at localhost");
			$dalTables[$conn->connId][] = array("name" => "Requestor", "varname" => "pqrsf_at_localhost__Requestor", "altvarname" => "Requestor", "connId" => "pqrsf_at_localhost", "schema" => "", "connName" => "pqrsf at localhost");
			$dalTables[$conn->connId][] = array("name" => "Response", "varname" => "pqrsf_at_localhost__Response", "altvarname" => "Response", "connId" => "pqrsf_at_localhost", "schema" => "", "connName" => "pqrsf at localhost");
			$dalTables[$conn->connId][] = array("name" => "Tracking", "varname" => "pqrsf_at_localhost__Tracking", "altvarname" => "Tracking", "connId" => "pqrsf_at_localhost", "schema" => "", "connName" => "pqrsf at localhost");
		}
	}
